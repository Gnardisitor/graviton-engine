...
class TestSystem : public System {
    private:
    static constexpr int testBodies = 2;
    ...
    static constexpr double velocities[] = {0.000006, -0.000000, -0.000000, -0.017198, -0.003189, -0.000001};
    static constexpr double expectedPositions[] = {0.001151, 0.000822, -0.000059, -0.172668, 0.968633, -0.000040};
    ...
    static constexpr double year = 365.0;
    static constexpr double day = 86400.0;
    static constexpr double totalYear = year * day;

    static constexpr double massSun = 1.989e30;
    static constexpr double massScale = (g * totalYear * totalYear) / (au * au * au);
